...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo">Addiction Monitoring System</a></li>
			...
			<div class="center">
				<h1></h1><br>
				<h1 style="text-align:center;color:white;font-size:30px;top:35%">Addiction Monitoring System</h1><br>
